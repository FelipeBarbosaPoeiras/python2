...
class Locacao(ModeloBase):
    ...
    # relationship: permite locacao.cliente.nome e locacao.veiculo.placa nos templates
    # back_populates espelha o relacionamento no outro lado (cliente.locacoes, veiculo.locacoes)
    ...
    def __repr__(self):
        return f"<Locacao {self.id} cliente={self.cliente_id} veiculo={self.veiculo_id}>"
