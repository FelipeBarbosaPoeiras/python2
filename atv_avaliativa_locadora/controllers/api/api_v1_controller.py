...
def api_modelos_nhtsa():
    # request.args.get lê query strings (?marca=Toyota) em requisições GET.
    # Usamos o parâmetro opcional "Honda" como valor padrão para o caso de
    # o cliente da API não informar a marca na URL, evitando um KeyError.
